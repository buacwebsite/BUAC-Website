    ...
    ? data.comments
        .filter(
          (comment): comment is BlogComment =>
            ...
            typeof comment.authorRole === "string" &&
...
function toPublicInteraction(
  ...
  return {
    ...
    likedByCurrentUser:
      ...
      interaction.likes.includes(
        normalizedCurrentEmail,
      ),

    comments: interaction.comments.map(
      (comment) => ({
        id: comment.id,
        authorName: comment.authorName,
...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(
      {
        error:
          "Failed to fetch blog interactions.",
      },
      {
        status: 500,
      },
  ...
  try {
    ...
    if (action === "add-comment") {
      ...
      const comment: BlogComment = {
        ...
        /*
         * Store raw text to preserve user paragraph
         * breaks/spaces in comments as well.
         */
        content,
        createdAt:
    ...
    return NextResponse.json(
      {
        error:
          "Failed to update blog interaction.",
      },
      {
        status: 500,
      },
...
export async function DELETE(
  ...
  try {
    ...
    console.error(
      "Blog interactions DELETE error:",
      error,
    );
