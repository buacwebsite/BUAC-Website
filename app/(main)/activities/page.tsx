...
const Activities = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background py-20 px-6 lg:px-12 font-poppins">
        <div className="max-w-7xl mx-auto mb-16 text-center flex flex-col items-center">
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-bebasNeue text-text-secondary leading-none tracking-tight mb-4">
            ACTIVITIES
          </h1>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {activities.map((activity) => (
            <Link
              ...
              className="group bg-background border border-text-muted/20 rounded-2xl overflow-hidden hover:border-accent/50 transition-all duration-300 hover:shadow-xl hover:shadow-accent/10 cursor-pointer"
            >
                ...
                {activity.imageUrl ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-accent/20 to-accent/5 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <div className="text-sm text-text-muted/50">No image</div>
                    </div>
                  </div>
                )}
